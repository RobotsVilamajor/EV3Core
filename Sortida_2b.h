...
// Sortida sense tornar a la base
...
void Sortida_2b(bool align = false)
{
	...
	Recta(Fwd, 3.1, 65, true, false);
	MoveMotorAsync(motorB, 0.2, -30);
	MoveMotor(motorC, 0.2, -30);
	delay (500);
	MoveMotorAsync(motorA, 0.2, 50);
	MoveMotor(motorD, 3.7, 70);
	Recta(Fwd, 0.15, 40, true, true);
	MoveMotor(motorA, 1.15, 70);
